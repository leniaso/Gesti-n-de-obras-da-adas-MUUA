...
public class RestauracionService {
    ...
    public List<Restauracion> listarTodas() {
        return repo.findAll();
    }
    ...
    public List<Restauracion> filtrarPorObraDeteriorada(Integer id) {
        return repo.findByObraDeterioradaId(id);
    }

    public List<Restauracion> filtrarPorRangoFecha(LocalDate desde, LocalDate hasta) {
